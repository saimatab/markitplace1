...
public class Footer {
	...
	public Footer(WebDriver driver ) 
	{
		...
		this.driver=driver;
			...
			By FootLogo = By.xpath("/html[1]/body[1]/footer[1]/div[1]/section[1]/a[1]/div[1]/img[1]");
	...
	//By FFavoritesFF=By.xpath("//div[@class='footer-top-right clearfix']//a[contains(text(),'Favorites')]");
